package ifc.sisdi.tpc.replica.controller;

import ifc.sisdi.tpc.replica.exception.NoException;
import ifc.sisdi.tpc.replica.models.Account;
import ifc.sisdi.tpc.replica.models.Action;
...
public class AccountController {
    ...
    public Action sendAction(Action action){
    	System.out.println("Replica 1: ação enviada "+ action.getId());
        Random r = new Random();
...
//                }
    ...
    public Action commit(int id){
    	System.out.println("Replica 1: commitando: "+ id);
    	System.out.println(this.log);
...
//        }
    ...
    public void rollback(int id){
    	System.out.println("Replica 1: dando rollback: "+ id);
    	int indexAction = 0;
    	int counter = 0;
    	boolean achou = false;
    	for(Action actionMap : this.log){
